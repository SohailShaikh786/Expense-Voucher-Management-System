...
export default function VoucherCreateEditPage() {
  ...
  if (isLoadingVoucher) {
    return (
      <div className="max-w-3xl mx-auto p-8 text-center text-ink-500">
    ...
    <div className="max-w-3xl mx-auto page-shell">
      ...
      <div className="mb-6">
        <Link
          ...
          className="inline-flex items-center gap-1.5 text-xs font-semibold text-ink-500 hover:text-ink-800 mb-2 transition-colors"
        >
      ...
      {/* Main Form */}
      <form className="panel p-6 sm:p-8 space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
          ...
          <div>
            ...
            <div className="relative">
              <span className="absolute left-3.5 top-1/2 -tranink-y-1/2 text-ink-400 font-semibold">$</span>
              <input
                type="number"
                step="0.01"
                min="0.01"
        ...
        <div className="pt-4 border-t border-ink-100">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 p-4 rounded-xl border border-dashed border-ink-300 bg-ink-50/50">
            {signaturePreview ? (
              <div className="flex items-center gap-4 bg-white p-2.5 rounded-lg border border-ink-200 shadow-xs">
                <img
                  src={signaturePreview}
                  alt="Employee Signature"
                  className="h-16 w-36 object-contain border border-ink-100 rounded bg-ink-50"
                />
                <div>
            ...
            <button
              ...
              className="px-4 py-2 bg-white hover:bg-ink-100 border border-ink-200 rounded-xl text-xs font-semibold text-ink-700 flex items-center gap-2 shadow-xs transition-colors ml-auto"
            >
        ...
        <div className="pt-5 border-t border-ink-100 flex flex-col sm:flex-row items-center justify-end gap-3">
          <Link to="/employee/vouchers" className="btn-secondary w-full sm:w-auto">
            Cancel
          </Link>
