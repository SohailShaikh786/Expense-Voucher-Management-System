  ...
  if (error || !voucher) {
    return (
      <div className="max-w-xl mx-auto p-8 bg-white rounded-2xl border border-ink-200 text-center shadow-sm">
        ...
        <h3 className="text-lg font-bold text-ink-800">Unable to view voucher</h3>
        <p className="text-sm text-ink-500 mt-1">{error || 'Voucher not found.'}</p>
        <Link
          ...
          {voucher.status === 'DRAFT' && (
            <>
              <Link
                ...
                className="px-3.5 py-2 bg-ink-100 hover:bg-ink-200 text-ink-700 text-xs font-semibold rounded-xl flex items-center gap-1.5 transition-colors"
              >
      ...
      <div className="bg-white rounded-2xl border border-ink-200 shadow-sm p-6 sm:p-8 space-y-6">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 text-sm">
          <div className="p-4 bg-ink-50/80 rounded-xl border border-ink-100">
            ...
            <span className="text-xl font-bold text-ink-800 mt-1 block">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="p-4 border border-ink-200 rounded-xl bg-ink-50/50">
              <div className="flex items-center justify-between text-xs mb-2">
                <span className="font-bold text-ink-700">Claimant Signature (Employee)</span>
            ...
            <div className="p-4 border border-ink-200 rounded-xl bg-ink-50/50">
              <div className="flex items-center justify-between text-xs mb-2">
                <span className="font-bold text-ink-700">Approval Signature (Director)</span>
                {voucher.directorSignatureUrl ? (
                  ...
                  <span className="text-ink-400 italic">Pending Review</span>
                )}
              </div>
              <div className="h-24 bg-white rounded-lg border border-dashed border-ink-200 flex items-center justify-center p-2">
                {voucher.directorSignatureUrl ? (
                  ...
                  <span className="text-xs text-ink-400 italic">Awaiting Director Signature</span>
                )}
              </div>
              <div className="mt-2 text-xs text-ink-500 flex justify-between">
